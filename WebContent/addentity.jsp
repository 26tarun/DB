				...
				<div class="templatemo_post">
					<form id="login" action="entityServlet" method="post" name="myForm"  onsubmit="return(validate());">
						...
						<div class="templatemo_post_mid" style="height: 400px">
							...
							<div id="event">
								<table border="0">
									...
									<tr>
										...
										<td><input placeholder="YYYY-MM-DD HH:MM:SS"type="text" id="eventdate" name="eventdate" maxlength="19"></td>
									</tr>
							...
							<table><tbody><tr><td>
							<input class ="button-secondary" type="submit" value="Submit"></td></tr></tbody></table>
						</div>
